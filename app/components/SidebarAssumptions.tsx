...
import { MoneyInput } from './ValueInputs';
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => setPlan({ ...plan, currency: safeCurrency(e.target.value) })}
              placeholder="USD"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setPlan({ ...plan, startMonthISO: toMonthISO(e.target.value) })}
              placeholder="2026-01"
            />
          </div>
          ...
          <div>
            ...
            <MoneyInput
              className={input}
              value={plan.startingNetWorth ?? 0}
              onValue={(n) => setPlan({ ...plan, startingNetWorth: n })}
              ariaLabel="Legacy starting net worth"
            />
            <div className="mt-1 text-xs text-slate-500 dark:text-slate-400">
              Used only if you have no account balances. Prefer adding balances under Assumptions → Net Worth (investments).
            </div>
          </div>
          ...
          <div>
            ...
            <MoneyInput
              className={input}
              value={plan.goalNetWorth ?? 0}
              onValue={(n) => setPlan({ ...plan, goalNetWorth: n })}
              ariaLabel="Goal net worth"
            />
          </div>
        </div>
      </div>
